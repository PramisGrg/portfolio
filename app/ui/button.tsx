...
export default function RippleButton({
  ...
  return (
    <button
      ref={buttonRef}
      className=" duration-[600ms] relative flex items-center border border-gray-800 justify-center overflow-hidden rounded-full bg-primary p-[1.3rem] text-[1.2rem] text-white transition"
      onMouseEnter={(e) => {
